...
|---|---|---|
| Tests passing | **2,545 passing**, 4 intentionally skipped | `pytest` |
...
| Aspect | Rating | Reason |
|---|---|---|
| Test coverage & depth | **95%** | 2,545 passing, 93% coverage, provenance tagged G1-G5. Weakest: UI paths - `risk_view` 56%, `fund_inputs` 57%. |
